import { parseWorkflowMetadata } from './knime-parser';
...
describe('KNIME Parser', () => {
  it('should extract basic metadata', () => {
    const metadata = parseWorkflowMetadata(mockXml, 'Fallback');
  ...
  it('should handle malformed or missing config', () => {
    ...
    const metadata = parseWorkflowMetadata(emptyXml, 'Fallback');
